...
export const ButtonGold = ({ btnProps }) => {
  ...
  return (
    <Link to={linkTo} className="">
      <div
        className="w-fit px-[3rem] py-[1.1875rem] bg-orangeLG z-1 relative overflow-hidden after:w-[27%]
...
export const ButtonBlue = ({ btnProps }) => {
  ...
  return (
    <Link to={linkTo} className="">
      <div
        className="w-fit px-[3rem] py-[1.1875rem] bg-blue z-1 relative overflow-hidden after:w-[27%]
...
export const ButtonGoldNormal = ({ btnProps }) => {
  ...
  return (
    <button
      onClick={handleClick}
      disabled={disabled}
      className="w-fit px-[2.25rem] py-[1.1875rem] bg-orangeLG z-1 relative overflow-hidden
